    ...
    <div suppressHydrationWarning style={{minHeight:"100vh",background:C.bg,color:C.text,fontFamily:"'Inter','Segoe UI',sans-serif",overflowX:"hidden",position:"relative"}}>
      ...
      <section style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"100px 24px 60px"}}>
        <div style={{ width: "100%", maxWidth: 900 }}>
          ...
          <h1 style={{fontFamily:"'Orbitron'",fontSize:"clamp(28px, 6vw, 52px)",fontWeight:800,lineHeight:1.25,marginBottom:22,maxWidth:800,marginLeft:"auto",marginRight:"auto",animation:"fadeUp .8s ease .2s both"}}><span style={{color:C.text}}>Учиться так, что </span><span className={theme === "dark" ? "nu-gradient-text" : "nu-gradient-text-light"}>не хочется останавливаться</span></h1>
      ...
      <div style={sectionWrap}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 300px), 1fr))", gap: 18 }}>
          {scienceBlocks.map((b, i) => (
            <div key={i} style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 18, padding: "30px 26px", display: "flex", flexDirection: "column", gap: 14, boxShadow: C.cardShadow }}>
              <div className={theme === "dark" ? "nu-gradient-text" : "nu-gradient-text-light"} style={{ fontFamily: "'Inter', sans-serif", fontSize: 44, fontWeight: 900, lineHeight: 1, letterSpacing: "-1px" }}>{b.digit}</div>
        ...
        <p style={{ textAlign: "center", marginTop: 32, fontSize: 17, fontWeight: 500, color: C.text, lineHeight: 1.6 }}>
          На бесплатном уроке ты увидишь каждую из этих механик <span className={theme === "dark" ? "nu-gradient-text" : "nu-gradient-text-light"} style={{ fontWeight: 700 }}>в действии</span>.
        </p>
      </div><SectionDiv C={C}/>
